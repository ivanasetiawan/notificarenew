<fieldset>
	...
	<div class="field">
		...
		<input type="text" name="actions[${counter}][target]" value="tel:">
 		<div class="tooltip push-form-action-tooltips" data-ot="${dictionary.getText('action_tel_label_info_text')}" data-ot-hide-trigger="closeButton" data-ot-fixed="true">i</div>
	</div>
