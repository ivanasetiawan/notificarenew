<fieldset>
	...
	<div class="field">
		<label for="target">${dictionary.getText('email')}</label>
		<input type="text" name="actions[${counter}][target]">
 		<div class="tooltip push-form-action-tooltips" data-ot="${dictionary.getText('action_mail_label_info_text')}" data-ot-hide-trigger="closeButton" data-ot-fixed="true">i</div>
	</div>
